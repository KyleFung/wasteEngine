...
bool Mesh::loadSceneFromFiles(const std::string fileName)
{
...
bool Mesh::initSubMesh(const int n, const aiMesh* pMesh)
{
...
bool Mesh::initTextures(const aiScene *pScene, const std::string fileName)
{
